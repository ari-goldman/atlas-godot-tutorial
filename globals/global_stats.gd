...
## Augments
var augment_time: int = 20 # minimum time for augments to drop (seconds)
var spawn_augments = false # whether or not augments are spawning
var augment_drop_chance: float = 0.2 # chance to drop any augment
...
## Border
var border_expansion_size: Vector2 = Vector2(75, 75)
